...
rsultado = zip(tupla,lista,tupla2) #unir n numeros de listas y tuplas en una sola. devuelve una matriz cuadrada
rsultado = tuple(rsultado) #asignamos a una variable al nueva tupla o lsita como querramos list(rsultado)
print(rsultado)
"""
